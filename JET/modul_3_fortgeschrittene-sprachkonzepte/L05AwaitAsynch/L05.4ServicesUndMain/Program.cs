...
public class Programm
{
    public static async Task Main(string[] args)
    {
        ...
        // vs. 
        // gleichzeit
        await userService.AddUserAsync(new UserDTO { Name = "Anna", Email = "anna@test.com" });
        await userService.AddUserAsync(new UserDTO { Name = "Ben", Email = "ben@test.com" });
        ...
        var users = new List<UserDTO> { userId1, userId2 };
