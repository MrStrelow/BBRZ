...
public class Hund
{
    ...
    public void SetSpielfreund(Hund spielfreund)
    {
        ...
        { 
            ...
            spielfreund.spielfreund = this;
        }
    }

    public void SetBesitzer(HundeBesitzer besitzer)
    {
        if (this.besitzer is null && !besitzer.BesitztHund(this)) // TODO: was wenn ich schon vom gleichen Besitzer bessesn wurde?
        {
        ...
        {
            Console.WriteLine($"Zuwesung verboten! {this.GetHashCode()} ist bereits besessen.");
        }
    }
}
