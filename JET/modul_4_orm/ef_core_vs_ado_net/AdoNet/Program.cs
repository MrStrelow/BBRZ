...
namespace ADONETConsoleApp
{
    class Program
    {
        // Definieren Sie hier Ihre Verbindungszeichenfolge.
        private static readonly string _connectionString = "Server=(localdb)\\mssqllocaldb;Database=FruehstuecksrestaurantADO;Trusted_Connection=True;";
