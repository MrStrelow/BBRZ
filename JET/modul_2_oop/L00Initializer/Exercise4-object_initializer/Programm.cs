public class Person
{
    ...
    public string Name {
        set
        {
            ...
            // != works if _name is null and Equals does not work and throws an exception
            //if (!_name.Equals("Hallo"))
            //{
            //    Name = value;
            //}
        }
        get => _name;  // return _name otherwise...
        //get => Name;  // ininite loop because Name is the method
    }
