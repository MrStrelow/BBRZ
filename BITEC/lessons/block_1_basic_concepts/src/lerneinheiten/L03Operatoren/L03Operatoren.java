...
//        System.out.println( (++((++index)++))++ );
        ...
        // Wir haben, wenn wir Methoden verwenden, einen Aufruf eines Operators versteckt.
        // Der "." nach der Variable oder des Typs ist der Mitgliedszugriffsoperator bzw. nur Zugriffsoperator.
        // Dieser ist ein unärer Operator welcher die Variable oder den Typ nimmt und uns erlaubt die methoden aufzurufen.
