package lerneinheiten.L03FilesUndExceptions.kommunikation_mit_files;
...
public class IOPackageFileWriterReader {
    public static void main(String[] args) {
        ...
        String filePath = "src/lerneinheiten/L03FilesUndExceptions/kommunikation_mit_files/example.txt";
