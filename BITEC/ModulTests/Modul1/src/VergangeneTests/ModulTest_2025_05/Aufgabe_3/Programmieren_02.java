package VergangeneTests.ModulTest_2025_05.Aufgabe_3;
...
public class Programmieren_02 {
    ...
    static int convertWordToNumber(String wordInput) {
        ...
        return switch (wordInput.toLowerCase()) {
            ...
            case "hundert", "ein-hundert" -> 100; // Added "hundert" to match common usage and pattern
            default -> -1; // Indicates an invalid word not caught by regex or not in switch
        };
    }
    ...
    static void displayGameStatus(int guess, int zahlZuRaten, int livesLeft) {
        if (guess > zahlZuRaten) {
            ...
            System.out.println("Die Zahl ist größer. Du hast noch " + livesLeft + " Leben.");
        }
    }
