...
public class L06VerzweigungenIF {
    public static void main(String[] args) {
        ...
        // ############################## IF/IF-ELSE/ELSE-IF ##############################
        // ##### IF #####
        // Ein IF wird auch IF-Anweisung genannt. Das soll den Begriff einer bedingten Anweisung andeuten.
        // Eine bedingte Anweisung ist ein Stück Programmcode, welche an eine Bedingung (boolescher Wert) geknüpft ist.
        // Wenn die Bedingung wahr ist, wird die Anweisung (Programmcode) ausgeführt, ansonsten nicht.
        // Wir sehen eine IF-Anweisung als einen Spezialfall einer Verzweigung. Dazu aber später mehr.

        // Wir brauchen für die if-Anweisung folgendes.
        // 1) Eine boolesche Aussage (Bedingung), welche steuert, ob wir die Anweisung ausführen oder nicht.
        // 2) Den Befehl (die Syntax) welche notwendig ist um "if" in JAVA schreiben zu können.
        // 3) Die Anweisung welche ausgeführt wird, wenn die Bedingung zutrifft.
        ...
        // Zum Vergleich, wenn wir unterhalb oder über der IF-Anweisung code schreiben wird dieser immer ausgeführt.
        ...
        // Ein IF mit einem ELSE, ein IF-ELSE ist also allgemein eine IF-Verzweigung genannt.
        // Wir nennen also eine IF-Anweisung wenn nur ein IF vorkommt,
        // und wenn ein else dabei ist, eine IF-Verzweigung.
        ...
        // Der Baum einer einzelnen if-Anweisung sieht so aus:
        /*
                   ()
                    \
           x == 5    \
        ...
        // Wir sprechen hier von sogenannten Mehrfachverzweigungen.
        // Eine solche ist das else-if und auch das switch.
        ...
        // Dies führt zu einer Verschachtelung der IF Verzweigung (IF-ELSE).
        ...
        // Das führt uns zum ELSE-IF, was eine Mehrfachverzweigung ist. Diese erlaubt uns den obigen
        // Ausdruck einfacher zu schreiben. Dieser wird jetzt folgendermaßen geschrieben. In anderen Sprachen,
        ...
        // ACHTUNG! das verschachtelte IF-ELSE (IF-Verzweigung) ist streng genommen allgemeiner als das ELSE-IF (Mehrfachverzweigung)!
        ...
        // Betrachten wir nun eine geschachteltes if-else welche nicht als else-if darstellbar ist.
        // Konkreter:
