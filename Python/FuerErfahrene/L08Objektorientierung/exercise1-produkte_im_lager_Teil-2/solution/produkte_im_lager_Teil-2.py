...
class Product:
    def __init__(self, product_id: int, product_type: ProductType):
        self.product_id = product_id
        self.product_type = product_type

    def __repr__(self):
        return f"Product(id={self.product_id}, type={self.product_type.value})"


class Box:
    def __init__(self, box_id: int, box_type: BoxType):
        self.box_id = box_id
    ...
    def __repr__(self):
        return f"Box(id={self.box_id}, type={self.box_type.value}, products={self.products})"
