package block2.Klassen2;

public class Main {

    /*
    Die Überlegungen aus den UML-Klassendiagramm werden wir nun in JAVA block2.Klassen übersetzen.
    Wir haben uns dort folgendes überlegt:
        ...
        Daraus sind folgende block2.Klassen, Attribute, Methoden und Beziehungen entstanden:
            - block2.Klassen:
                Hund:
        ...
        Gilbert 5 Jahre ist. Wir können beliebig viele Objekte von block2.Klassen erzeugen. Wir können also Hunde erzeugen welche nun
        ...
        Diese erlauben uns Verhalten von block2.Klassen zu spezifizieren.
        ...
        Aber wie lesen und schreiben wir block2.Klassen, Attribute und Methoden und dessen Relationen?
