...
public class L05UserInput {
    public static void main(String[] args) {
        ...
        // Das lässt vermuten, dass wir nicht nur die Console als "Ort der Eingabe" festelegen können, sondern auch z.B. ein Textfile, Word, usw.).
        ...
        // Wir sehen nun was der Unterschied ist! nextLine liest solange bis ein \n kommt und next liest bis ein Leerzeichen kommt.
        // Wir können aber spezifizieren was dieses Trennzeichen ist.
