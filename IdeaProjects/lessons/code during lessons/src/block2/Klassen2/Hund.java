...
public class Hund {
    ...
    */
    ...
    Hier in JAVA ist der Unterschied, dass eigens erstellte block2.Klassen eben als <hat> Relation dargestellt sind, ansonsten
    ...
    */
    ...
    // methoden:
       ...
       Nach der Sichtbarkeit, ist der RÜCKGABETYP der Methode zu schreiben (int, Integer, Hund, Hund[], jeder bekannte Datentyp und eigens erstellte block2.Klassen).
